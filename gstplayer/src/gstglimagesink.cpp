...
static const char gst_vaapisink_sink_caps_str[] =
	GST_VIDEO_CAPS_MAKE_WITH_FEATURES ( "memory:VASurface", "{ ENCODED, NV12, I420, YV12 }") "; "
...
gst_glimage_sink_class_init (GstGLImageSinkClass * klass)
{
  ...
  g_object_class_install_property (gobject_class, PROP_OTHER_CONTEXT,
      g_param_spec_object ("other-context",
          ...
          GST_GL_TYPE_CONTEXT,(GParamFlags)(G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS)));
    ...
    const GValue * value, GParamSpec * pspec)
{
  ...
  switch (prop_id) {
    ...
    case PROP_OTHER_CONTEXT:
    {
      ...
      glimage_sink->other_context = (GstGLContext*) g_value_dup_object (value);
      break;
    }
    default:
...
// 		qDebug() << "query caps" <<gst_caps_to_string(caps);

// 		GstGLImageSink * parent =(GstGLImageSink*) GST_OBJECT_PARENT(pad);
